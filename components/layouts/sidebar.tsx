        ...
        <div className="p-6">
          <div className="flex items-start justify-between gap-2">
            <div className="flex-1">
              <h1 className="text-xl font-bold text-teal-600">Sistema de Gestión de Consultorios AI</h1>
              <p className="text-sm text-gray-500 mt-1">Demo Interactivo</p>
            </div>
            <span className="px-2 py-1 text-xs font-semibold text-white bg-gradient-to-r from-teal-500 to-blue-500 rounded-full">
              DEMO
            </span>
          </div>
        </div>
